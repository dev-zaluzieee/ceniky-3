...
/**
 * Plisé blinds form edit page - Server Component
...
export default async function PliseZaluzieFormEditPage({
  ...
  // Transform form_json to PliseZaluzieFormData
  // The form_json should already match PliseZaluzieFormData structure
  const initialData = form.form_json as PliseZaluzieFormData;
  ...
  return (
    <PliseZaluzieFormClient initialData={initialData} formId={formId} />
  );
}
