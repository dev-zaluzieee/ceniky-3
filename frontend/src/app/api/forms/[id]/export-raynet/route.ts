/**
 * Next.js API route proxy for Raynet export.
 * Forwards authenticated POST to backend POST /api/forms/:id/export-raynet.
 */
...
export async function POST(
  ...
  try {
    ...
    const backendResponse = await fetch(`${getBackendUrl()}/api/forms/${id}/export-raynet`, {
      method: "POST",
      headers: {
    ...
    console.error("Error in POST /api/forms/[id]/export-raynet:", error);
    return NextResponse.json(
