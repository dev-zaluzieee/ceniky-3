/**
 * Next.js API route proxy for unified export (Raynet + ERP).
 * Forwards authenticated POST to backend POST /api/forms/:id/export.
 */
...
export async function POST(
  ...
  try {
    ...
    const backendResponse = await fetch(`${getBackendUrl()}/api/forms/${id}/export`, {
      method: "POST",
      headers: {
    ...
    console.error("Error in POST /api/forms/[id]/export:", error);
    return NextResponse.json(
